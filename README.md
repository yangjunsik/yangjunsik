...
저는 기획/설계, 개발, 테스트, 운영, 유지/보수까지
서비스의 전체를 보고 문제를 기술로 해결하는 Product Engineer입니다.

저의 핵심역량은 크게 3가지입니다

1. 시장조사와 수치데이터를 바탕으로 진짜 해결해야하는 문제를 정의합니다
2. 기획에 참여하여 명확한 의도와 방향을 문서화하고, 팀원과 소통을 중시합니다
3. 기술적 제약과 비스니스 리소스를 고려하여 최적의 제품 경로를 제안합니다.

위와 같은 역량을 바탕으로 서비스의 방향성과 현실성, 기술의 균형을 맞추고 있습니다
